...
// catalogRestCmd represents the orderRest command
var catalogRestCmd = &cobra.Command{
	Use:   "catalog-rest",
...
func init() {
	rootCmd.AddCommand(catalogRestCmd)

	// Here you will define your flags and configuration settings.

	// Cobra supports Persistent Flags which will work for this command
	// and all subcommands, e.g.:
	// catalogRestCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// catalogRestCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
